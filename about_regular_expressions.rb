...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # It will only fail if you have something before or after it and
    # it doesn't match.
  end
  ...
  # Why?
  # greed = avidos
  # Because they take as much chars as they can.
  # ------------------------------------------------------------------
  ...
  # (|).
  # A character class works like an AND-style character matching in which 
  # a given stringmatches a regular expression only if it matches all 
  # its components.
  # An alternation works more like an OR-style character matching in which
  # a given string matches a regular expression if it matches any of a 
  # defined set of choices. (those connected by |)
  # ------------------------------------------------------------------
