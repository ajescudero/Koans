...
It was the worst of times.
EOS
    assert_equal 53, long_string.length # no \n
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # for a = a + b (the same goes for the other <op>= operators) which
    # is an assignment. On the other hand << is an alias of concat() which
    # alters the receiver in-place.
  end
