...
class AboutSymbols < EdgeCase::Koan
  ...
  # Because, you would not be referring to the content of the identifier that refers to
  # this symbol but the object identity.
  ...
  # Because symbols remain memory resident until program ends which turns into
  # having lots of memory busy.
end
